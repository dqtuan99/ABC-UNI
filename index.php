...
<body>
	...
	<div class="limiter">
		<div class="container-login100" style="background-image: url('images/abcuni.jpeg');">
			<div class="wrap-login100 p-t-30 p-b-50">
				...
				<form method="post" class="login100-form validate-form p-b-33 p-t-5">
					...
					<!-- <div class="form-check login100-form">
					  <label class="form-check-label login100-form-checkbox">
